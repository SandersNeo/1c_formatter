...
* Сообщить об ошибке [тут](https://github.com/vladimir-kharin/1c_formatter/issues)
...
Формальностей на данный момент никаких нет. Просьба только сначала создавать [issue](https://github.com/vladimir-kharin/1c_formatter/issues), а pull request уже после обсуждения.
...
* Создать форк (копию) этого репозитория на [github](https://github.com/vladimir-kharin/1c_formatter) (кнопка справа вверху)
* Клонировать этот форк себе на диск: `git clone https://github.com/<ваш_аккаунт>/1c_formatter`
* Внести правки
