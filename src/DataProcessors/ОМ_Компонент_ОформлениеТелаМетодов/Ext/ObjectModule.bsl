...
Процедура ОформитьБлокЕсли(БлокЕсли)
	...
	Если СтрЧислоСтрок(ТекстУсловие) > 1 ИЛИ ЛогическаяСтрокаЗаканчиваетсяКомментарием(БлокЕсли.Условие) Тогда
...
Процедура ОформитьБлокИначеЕсли(БлокИначеЕсли)
	...
	Если СтрЧислоСтрок(ТекстУсловие) > 1 ИЛИ ЛогическаяСтрокаЗаканчиваетсяКомментарием(БлокИначеЕсли.Условие) Тогда
		ВывестиМногострочныйТекст(ТекстУсловие);
		НачатьНовуюСтроку();
	Иначе
		ВывестиТекст(ТекстУсловие);
...
Процедура ОформитьБлокПока(БлокПока)
	...
	Если СтрЧислоСтрок(ТекстУсловие) > 1 ИЛИ ЛогическаяСтрокаЗаканчиваетсяКомментарием(БлокПока.Условие) Тогда
		ВывестиМногострочныйТекст(ТекстУсловие);
		НачатьНовуюСтроку();
	Иначе
		ВывестиТекст(ТекстУсловие);
...
Процедура ОформитьБлокДля(БлокДля)
	...
	Если СтрЧислоСтрок(ТекстИнициализация) > 1 ИЛИ ЛогическаяСтрокаЗаканчиваетсяКомментарием(БлокДля.Инициализация) Тогда
	...
	Если СтрЧислоСтрок(ТекстКонецСчетчика) > 1 ИЛИ ЛогическаяСтрокаЗаканчиваетсяКомментарием(БлокДля.КонецСчетчика) Тогда
...
Процедура ОформитьБлокДляКаждого(БлокДляКаждого)
	...
	Если СтрЧислоСтрок(ТекстЭлемент) > 1 ИЛИ ЛогическаяСтрокаЗаканчиваетсяКомментарием(БлокДляКаждого.Элемент) Тогда
		ВывестиМногострочныйТекст(ТекстЭлемент);
		НачатьНовуюСтроку();
	Иначе
	...
	Если СтрЧислоСтрок(ТекстКоллекция) > 1 ИЛИ ЛогическаяСтрокаЗаканчиваетсяКомментарием(БлокДляКаждого.Коллекция) Тогда
