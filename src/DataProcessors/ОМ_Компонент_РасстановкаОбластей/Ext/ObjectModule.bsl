...
Функция ОбластьСодержимое(Имя, Комментарий = "", КомментарийВСтрокеОбласть = "", КомментарийПослеКонецОбласти = "")
	Возврат Новый Структура("Имя, Комментарий, КомментарийВСтрокеОбласть, КомментарийПослеКонецОбласти", Имя, Комментарий, КомментарийВСтрокеОбласть, КомментарийПослеКонецОбласти);
КонецФункции
