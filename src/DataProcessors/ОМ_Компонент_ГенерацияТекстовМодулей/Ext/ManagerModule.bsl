...
Функция ТекстОбластьНачало(АнглСинтаксис = Ложь) Экспорт 
	Возврат ?(АнглСинтаксис, "#Region", "#Область");
КонецФункции

Функция ТекстОбластьКонец(АнглСинтаксис = Ложь) Экспорт
	Возврат ?(АнглСинтаксис, "#EndRegion", "#КонецОбласти");
КонецФункции

Функция ТекстПроцедура(АнглСинтаксис = Ложь) Экспорт
	Возврат ?(АнглСинтаксис, "Procedure", "Процедура");
КонецФункции

Функция ТекстКонецПроцедуры(АнглСинтаксис = Ложь) Экспорт
	Возврат ?(АнглСинтаксис, "EndProcedure", "КонецПроцедуры");
КонецФункции

Функция ТекстФункция(АнглСинтаксис = Ложь) Экспорт
	Возврат ?(АнглСинтаксис, "Function", "Функция");
КонецФункции

Функция ТекстКонецФункции(АнглСинтаксис = Ложь) Экспорт
	Возврат ?(АнглСинтаксис, "EndFunction", "КонецФункции");
КонецФункции

Функция ТекстЭкспорт(АнглСинтаксис = Ложь) Экспорт
	Возврат ?(АнглСинтаксис, "Export", "Экспорт");
КонецФункции

Функция ТекстПерем(АнглСинтаксис = Ложь) Экспорт
	Возврат ?(АнглСинтаксис, "Var", "Перем");
КонецФункции

Функция ТекстЗнач(АнглСинтаксис = Ложь) Экспорт
