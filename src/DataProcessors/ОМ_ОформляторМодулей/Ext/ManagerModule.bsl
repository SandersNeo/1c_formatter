...
// Выполняет анализ текста модуля с использованием плагинов
// 
// Параметры:
//  ТекстМодуля      - Строка - Текст для анализа модуля
//  ПараметрыАнализа - Любой  - Параметры для плагина анализа
// 
// Возвращаемое значение:
//  Структура - Результаты анализа модуля
...
// 
// Возвращаемое значение:
//  Структура - Структура содержащая методы модуля
...
// 
// Возвращаемое значение:
//  Структура - Структура всех переменных в модуле
...
// Находит и возвращает первую выбранную строку из дерева структуры модуля.
// 
// Параметры:
//  ДеревоСтруктурыМодуля - ДеревоЗначений - Дерево, представляющее структуру модуля
// 
// Возвращаемое значение:
//  Массив - Первая строка с выбранным элементом или Неопределено
...
// Находит и возвращает ссылку на строку, представляющую модуль, в иерархии заданной строки.
// 
// Параметры:
//  ТекущаяСтр - Объект типа строка дерева - Исходная строка для поиска модуля
// 
// Возвращаемое значение:
//  Объект типа строка дерева - Строка модуля, если найдена, иначе Неопределено
