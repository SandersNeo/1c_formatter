...
Процедура ЗагрузитьСодержимоеСтрокиСтруктуры(ЭлементДереваСтруктуры)
	...
	ИначеЕсли ЭлементДереваСтруктуры.ТипЭлемента = "Процедура"
		...
		СигнатураТекстом = Обработки.ОМ_Компонент_ГенерацияТекстовМодулей.СигнатураМетодаHTML( 
			СтруктураСтрокиДереваМодуля(ЭлементДереваСтруктуры.ТипЭлемента, ЭлементДереваСтруктуры.Описание, Содержимое),
			Ложь, 
			Истина);
...
&НаСервере
Функция СтруктураСтрокиДереваМодуля(ТипЭлемента, Описание, Содержимое)
	Возврат Новый Структура("ТипЭлемента, Описание, Содержимое", ТипЭлемента, Описание, Содержимое);
КонецФункции
