...
Процедура ЗаполнитьМенюДействий()
	...
	Для Каждого МД Из СоставПодсистемыДействия Цикл
		...
		// AI! - здесь надо добавить обход в цикле таблицы КомандыДействий, для каждой программно добавить 
		// команды "КомандаДействие_" + МД.Имя + "_" + текКоманда.Идентификатор, а также
		// кнопку вызова команды с обработчиком КомандаДействие
