...
&НаСервере
Процедура РаспределитьПоОбластямНаСервере(АдресНовогоДереваСтруктуры)
	НовоеДеревоСтруктураМодуля = ПолучитьИзВременногоХранилища(АдресНовогоДереваСтруктуры);
