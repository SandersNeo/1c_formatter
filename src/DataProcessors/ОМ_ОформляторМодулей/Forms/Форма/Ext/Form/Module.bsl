...
Процедура ЗаполнитьМенюДействий()
	...
	КомандыДействийШаблон = Новый ТаблицаЗначений;
	КомандыДействийШаблон.Колонки.Добавить("Представление");
	КомандыДействийШаблон.Колонки.Добавить("Идентификатор");
	КомандыДействийШаблон.Колонки.Добавить("Порядок");
	КомандыДействийШаблон.Колонки.Добавить("СпособЗапускаДействия");  // ОткрытиеФормы или ВызовМетодаМодуляМенеджера
	...
	Для Каждого МД Из СоставПодсистемыДействия Цикл
		...
		КомандыДействий = КомандыДействийШаблон.СкопироватьКолонки();
		МенеджерОбработки.ДобавитьКомандыДействий(КомандыДействий);
		
		Для Каждого ТекКоманда Из КомандыДействий Цикл
			ИмяКоманды = "КомандаДействие_" + МД.Имя + "_" + ТекКоманда.Идентификатор;
			...
			// Добавляем кнопку
			НоваяКнопка = Элементы.Добавить(ИмяКоманды + "_Кнопка", Тип("КнопкаФормы"), Элементы.ГруппаДействия);
			НоваяКнопка.ИмяКоманды = ИмяКоманды;
			НоваяКнопка.Заголовок = ТекКоманда.Представление;
			НоваяКнопка.Порядок = ТекКоманда.Порядок;
		КонецЦикла;
