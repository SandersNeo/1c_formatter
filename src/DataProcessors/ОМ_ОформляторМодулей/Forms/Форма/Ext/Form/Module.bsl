...
Процедура ЗаполнитьМенюДействий()
	...
	КомандыДействий = Новый ТаблицаЗначений;
	КомандыДействий.Колонки.Добавить("ИмяОбработки");
	КомандыДействий.Колонки.Добавить("Представление");
	КомандыДействий.Колонки.Добавить("Идентификатор");
	КомандыДействий.Колонки.Добавить("Порядок");
	КомандыДействий.Колонки.Добавить("СпособЗапускаДействия");  // ОткрытиеФормы или ВызовМетодаМодуляМенеджера
